...
public class HTML_LandingPage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("     <a href=\"Invitation\"><div id=\"invitations\">");
            out.println("       <img src=\"img/invitations.png\"><h5>Invitations</h5>");
            out.println("   </div></a>");
            out.println("   <a href=\"GroupsList\"><div id=\"groups\">");
            out.println("     <img src=\"img/groups.png\"><h5>Groups</h5>");
            out.println("   </div></a>");
            out.println("   <a href=\"CreateGroup\"><div id=\"create\">");
            out.println("     <img src=\"img/create_group.png\"><h5>Create group</h5>");
            out.println("   </div></a>");
            out.println(" </div>");
            out.println("</body>");
            out.println("</html>");
